...
export const content = {
  fa: {
    ...
    hero: {
      ...
      tagline: 'رابط‌های کاربری سریع، زیبا و کاربرپسند می‌سازم و ایده‌ها را به محصولات واقعی تبدیل می‌کنم.',
      ctaPrimary: 'دیدن نمونه‌کارها',
      ctaSecondary: 'تماس با من',
      available: 'آماده همکاری در پروژه‌های جدید',
    },
    about: {
      title: 'درباره من',
      body: [
  ...
  en: {
    ...
    hero: {
      ...
      tagline: 'I build fast, beautiful and user-friendly interfaces, turning ideas into real products.',
