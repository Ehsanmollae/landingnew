// Tuning for the three cats. Speeds are in px/second for a 96px cat and scale with size.
  ...
  cats: [
    {
      ...
      weights: { sit: 3, walk: 2, trot: 1, hop: 2, chase: 9, groom: 1, stretch: 0.5, yawn: 0.3, sleep: 0.5, knock: 1, box: 0.6, sunbathe: 0.2, type: 0.8, zoomies: 0.6 },
      start: 'sit',
    },
    {
      id: 'orange',
      colors: { fur: '#F08A2B', far: '#d4731b', line: '#b85c10', stripe: '#d0680f', stripes: true, iris: '#7BC67B', pupil: '#1C1C1E', lid: '#8a4508', nose: '#a8480c' },
      weights: { sit: 4, walk: 1.5, trot: 0.3, hop: 1, chase: 1.5, groom: 1, stretch: 0.8, yawn: 1, sleep: 3, knock: 0.4, box: 3, sunbathe: 3, type: 0.5, zoomies: 0.1 },
      start: 'sleep',
    },
    {
      id: 'white',
      colors: { fur: '#FAFAFA', far: '#e9e4da', line: '#cfc7b8', stripe: '#e5dfd3', iris: '#5DADE2', pupil: '#1C1C1E', lid: '#b3aa99', nose: '#e8a0a8', outline: '#d9d2c4' },
      weights: { sit: 3, walk: 2, trot: 0.6, hop: 1.5, chase: 3, groom: 3, stretch: 1.2, yawn: 0.5, sleep: 1, knock: 3, box: 1, sunbathe: 0.5, type: 1, zoomies: 0.4 },
      start: 'groom',
    },
  ],
}
